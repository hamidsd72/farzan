...
@section('body')
    <div class="condition pull-right w-100 mb-2">
        ...
        <form action="{{ route('section.update',$item->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
            <fieldset>
                <div class="row">
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select name="type" class="form-control">
                                <option value="new" @if($item->type=='new') selected‍ @endif>تازه ها</option>
                                <option value="working" @if($item->type=='working') selected‍ @endif>در حال اجرا</option>
                                <option value="read_more" @if($item->type=='read_more') selected‍ @endif>بیشتر بدانیم</option>
                            </select>
                        </div>‍‍
                    </div>
                    <div class="col-lg-12">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <select name="status" class="form-control">
                                <option value="‍‍active" @if($item->status=='‍‍active') selected‍ @endif>فعال باشد</option>
                                <option value="deactivate"‍ @if($item->status=='deactivate') selected‍ @endif> غیر فعال باشد</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-4">
                ...
                <div class="col-lg-12">
                    <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                        ...
                        <input type="text" class="form-control d-ltr" id="description" name="description" value="{{ $item->description }}"/>
