        ...
        <div class="condition pull-right w-100 mb-2">
            ...
            <form action="{{ route('admin-menu-update', $item->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                <fieldset>
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <label for="photo" class="form-label">محل قرارگیری زیر منو درباره ما
                                :</label>
                            <select name="menu_type" class="form-control">
                                <option value="menu_0" {{$item->menu_type=='menu_0'?'selected':''}}>زیر منو نباشد</option>
                                <option value="menu_1" {{$item->menu_type=='menu_1'?'selected':''}}>زیر منو معرفی شرکت</option>
                                <option value="menu_2" {{$item->menu_type=='menu_2'?'selected':''}}>زیر منو دپارتمان ها</option>
                            </select>
                        </div>
                    </div>
