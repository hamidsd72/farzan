                ...
                <div class="form-group">
                    <div class="col-md-12">
                        ...
                        <select name="menu_type" class="form-control">
                            <option value="menu_0" {{old('menu_type')=='menu_0'?'selected':''}}>زیر منو نباشد</option>
                            <option value="menu_1" {{old('menu_type')=='menu_1'?'selected':''}}>زیر منو معرفی شرکت</option>
                            <option value="menu_2" {{old('menu_type')=='menu_2'?'selected':''}}>زیر منو دپارتمان ها</option>
                        </select>
                    </div>
                </div>
