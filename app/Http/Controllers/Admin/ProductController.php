...
//            'zeneric_name' => 'required',
            ...
            'text' => 'required',
            'text_en' => 'required',
            'text_masraf' => 'required',
            'text_masraf_en' => 'required',
//            'code' => 'required',
//            'status' => 'required',
            'photo' => 'required',
        ]);
        ...
        if(Product::where('slug_en',$request->slug_en)->first())
        {
            return redirect()->back()->with([
                'status' => 'danger-600',
...
//            'status' => 'required',
        ...
        if(Product::where('slug_en',$request->slug_en)->where('id','!=',$item->id)->first())
        {
            return redirect()->back()->with([
                'status' => 'danger-600',
                "message" => 'عنوان انگلیسی تکراری می باشد'
