...
//                if (is_file($item->index_pic)) {
//                    $old_path = $item->index_pic;
//                    File::delete($old_path);
//                }
//                $item->index_pic = file_store($request->index_pic, 'includes/asset/uploads/about/photos/', 'index_pic-');;
//            }
//            if ($request->hasFile('index_video')) {
//                if (is_file($item->index_video)) {
//                    $old_path = $item->index_video;
//                    File::delete($old_path);
//                }
//                $item->index_video = file_store($request->index_video, 'includes/asset/uploads/about/photos/', 'index_video-');;
//            }
            $item->update();
